    ...
    <div class="md:flex gap-4 justify-between mx-auto w-full">
      <div class="md:w-[40%]">
        <img
          v-if="currentImage"
          :src="currentImage"
          class="object-fit rounded-lg mt-[15px]"
        />
        <div
          v-if="images[0] !== ''"
        ...
        >
          <div v-for="image in images">
            <img
              ...
              width="70"
              class="object-fit rounded-md border-[3px] cursor-pointer"
      ...
      <div class="md:w-[60%] bg-white p-3 rounded-lg mt-[15px]">
        ...
        <div class="flex items-center pt-1.5">
          <span
            class="h-4 min-w-4 rounded-full flex items-center justify-center bg-[#FFD000] mr-2"
          >
        ...
        <div class="flex items-center justify-start mt-2">
          <Icon name="ic:baseline-star" style="color: #ff5353" />
          <Icon name="ic:baseline-star" style="color: #ff5353" />
          <Icon name="ic:baseline-star" style="color: #ff5353" />
          <Icon name="ic:baseline-star" style="color: #ff5353" />
          <Icon name="ic:baseline-star" style="color: #ff5353" />
