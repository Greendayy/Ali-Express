<template>
  <div id="MainLayout" class="w-full fixed z-50">
          ...
          >
            <div v-if="true">
              ...
              <div class="flex items-center gap-1 px-3 mb-3">
                <NuxtLink
                  to="/auth"
                  class="bg-[#FF4646] text-center text-[16px] w-full rounded-sm text-white font-semibold p-2"
                >
                  Login / Register
                </NuxtLink>
              </div>
            ...
            <ul class="bg-white">
              ...
              <li v-if="true" class="text-[13px] py-2 px-4 hover:bg-gray-200">
                Sign out
              </li>
            </ul>
          </div>
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div
        class="flex lg:justify-start justify-between gap-10 w-full max-w-[1150px] mx-auto px-3 py-5"
      >
          ...
          >
            <div class="min-w-[40px]">
              <Icon
                ...
                size="33"
                :style="isCartHover ? 'color:#FF4646;' : ''"
              />
            </div>
            <span
              class="absolute felx items-center justify-center -right-[-3px] top-0 bg-[#FF4646] h-[17px] min-w-[17px] text-white text-xs px-0.5 rounded-full"
            >
              0
            </span>
          </button>
